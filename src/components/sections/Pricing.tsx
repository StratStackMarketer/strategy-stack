...
const addon = [
  { name: 'AI Voice Receptionist', price: 'From $287/mo', description: 'Answers calls, books appointments, handles FAQs 24/7' },
  { name: 'AI Lead Follow-Up Agent', price: 'From $287/mo', description: '60-second lead response, qualification & nurture' },
  { name: 'Website Chatbot', price: 'From $178/mo', description: '24/7 on-site lead capture and qualification' },
  { name: 'Database Reactivation', price: 'From $178/mo', description: 'Re-engage dormant leads and past customers' },
